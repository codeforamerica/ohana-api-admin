...
feature "Update a location's accessibility options" do
  ...
  scenario "when location doesn't have any options", :vcr do
  ...
  scenario "when adding an option", :vcr do
    visit_test_location
  ...
  scenario "when removing an option", :vcr do
    visit_test_location
  ...
  scenario "when adding all options", :vcr do
    visit_test_location
