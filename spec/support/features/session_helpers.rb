  ...
  module SessionHelpers
    ...
    def reset_categories
      within('#categories') do
        ...
        uncheck 'category_102'
        uncheck 'category_103'
        uncheck 'category_104'
        uncheck 'category_105'
        uncheck 'category_106'
        uncheck 'category_107'
        uncheck 'category_108'
        uncheck 'category_109'
        uncheck 'category_110'
        uncheck 'category_111'
      end
      click_button 'Save changes'
    end
